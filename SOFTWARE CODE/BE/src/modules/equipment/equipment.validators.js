...
const listQuerySchema = z
  .object({
    ...
    sort: z.enum(['equipment_code', 'name', 'next_cal_due_date']).default('equipment_code'),
...
const createEquipmentSchema = z
  .object({
    ...
    make_id: z.coerce.number().int().positive(),       // FK to cmms_cont_mst.CMM_CONT_ID
    ...
    complaint_description: z.string().min(5).max(2000),
