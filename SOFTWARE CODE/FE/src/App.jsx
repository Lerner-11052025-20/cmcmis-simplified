      ...
      <BrowserRouter>
        ...
        <Suspense fallback={
          ...
          <Routes>
            ...
            />
            <Route
              path="/view-only-guide"
              element={
                <ProtectedRoute requiredRole="VIEW_ONLY">
                  <Layout><ViewOnlyGuide /></Layout>
                </ProtectedRoute>
              }
            />
            <Route
              ...
              element={
                <ProtectedRoute requiredRole={[
                  ...
                  <Layout><LabInChargeGuide /></Layout>
                </ProtectedRoute>
              }
            />
            <Route
            ...
            />
            <Route
              path="/admin/lab-capacity"
              element={
                <ProtectedRoute requiredPermission="analytics:view">
                  <Layout><LabCapacity /></Layout>
                </ProtectedRoute>
              }
            />
