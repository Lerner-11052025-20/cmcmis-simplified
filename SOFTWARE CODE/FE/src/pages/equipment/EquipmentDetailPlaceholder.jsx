            ...
            <div className="relative bg-white px-6 py-6 text-slate-900 md:px-8">
              ...
              <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div className="flex min-w-0 items-center gap-5">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-1.5 font-mono text-xs font-bold text-slate-600">
                        {display(data.equipment_code)}
                      </span>
                      <span className={`inline-flex items-center gap-2 rounded-lg border px-3 py-1.5 text-xs font-bold ${summary.status.chip}`}>
                ...
                <div className="grid min-w-[280px] grid-cols-2 gap-3">
                  ...
                  <div className="rounded-lg border border-slate-200 bg-slate-50/80 p-3">
                    <p className="text-xs font-semibold text-slate-400">Serial No</p>
                ...
                <Panel title="Location" subtitle="Division and room allocation." icon={MapPin}>
                  <div className="space-y-4">
                    ...
                    <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                      <p className="text-xs font-semibold text-slate-400">Parsed Location</p>
                      <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <table className="min-w-full divide-y divide-slate-200 text-left text-xs">
                      <thead className="bg-slate-50 text-slate-500">
                        <tr>
                          ...
                          <th className="px-4 py-3 font-bold">Serial No</th>
                        </tr>
                      </thead>
