...
/**
 * Downloads the job requests list as a PDF for a specified ID range.
 * Uses axios responseType: 'blob' to properly handle binary PDF stream.
 */
export async function downloadJobRequestsPdf(startId, endId) {
  const response = await api.get('/job-requests/export-pdf', {
